...
class Dealer(models.Model):
    ...
    create_user = models.OneToOneField(User,on_delete=models.CASCADE,verbose_name='Create user',null=True)
...
class Salesman(models.Model):
    ...
    dealer= models.ForeignKey(Dealer,on_delete=models.CASCADE,related_name='sales_asso_dealer',null=True,verbose_name='Dealer') #saso_dea = salesman association with dealer


    user = models.OneToOneField(User,on_delete=models.CASCADE,related_name='sales_asso_user',null=True,verbose_name='User') #saso_usr = salesman association with user
...
class Order(models.Model):
    ...
    unit = {('box','box'),('kilo','kilo')}
    

    quantity = models.CharField(max_length=4,null=True,choices=unit,verbose_name='Quantity')

    date_crt = models.DateTimeField(auto_now_add=True,verbose_name="Date created")

    sales = models.ForeignKey(Salesman,on_delete=models.CASCADE,related_name='order_asso_sales',null=True,verbose_name='Sales man')#Order association with sales
    

    item = models.ForeignKey(Items,on_delete=models.CASCADE,related_name='items_asso_sales',null=True,verbose_name='Item')#Item association with sales
